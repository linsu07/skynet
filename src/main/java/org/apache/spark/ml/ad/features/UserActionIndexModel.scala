...
import org.apache.spark.ml.util.{DefaultParamsReadable, DefaultParamsReader, DefaultParamsWritable, DefaultParamsWriter, MLReadable, MLReader, MLWritable, MLWriter}
...
object UserActionIndexModel extends DefaultParamsReadable[UserActionIndexModel]